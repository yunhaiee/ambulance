...
DATABASE IDs:
- 진료과: 22ba802d-36b4-803b-80ff-f0edb9e4a3f4
- 의사: 22ba802d-36b4-80b5-9188-c6939cda827a
- 공간: 22ba802d-36b4-8034-ab71-f5d069cc931e
...
Call API-post-database-query with database_id: "22ba802d-36b4-803b-80ff-f0edb9e4a3f4"
For department queries, use EXACTLY this structure:

{
  "database_id": "22ba802d-36b4-803b-80ff-f0edb9e4a3f4",
  "filter": {
    "property": "과이름",
    "title": {
...
Call API-post-database-query with database_id: "22ba802d-36b4-80b5-9188-c6939cda827a"
Use exact filter:

{
  "database_id": "22ba802d-36b4-80b5-9188-c6939cda827a",
  "filter": {
    "and": [
      {
        "property": "과번호",
...
Call API-post-database-query with database_id: "22ba802d-36b4-8034-ab71-f5d069cc931e"
...
입력받은 환자정보를 자신의 병원에 'slack_post_message'이라는 slack tool을 통해 연락하세요. 채널 아이디는 C096L5YHEJ2 (환자 상태에 대해 받은 정보와 수용가능/불가능 이유 모두 이 채널에 보고하세요.)
